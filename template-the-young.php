...
/*
Template Name: the young Template
*/
...
<section class="section">
    <div class="container">
        ...
        <div class="image module">
            ...
            <iframe width="100%"
                height="556px" src="https://www.youtube.com/embed/6TbbxreJOIg" title="Young Healthy Minds Forum 2023" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </div>
</section>
<section class="texts-theyoung">
    <div class="container">
        <div class="one-textss module">
            <div class="title">
                Introduction
            </div>
            <div class="sutbitlee">
        ...
        <div class="one-textss module">
            ...
            <div class="sutbitlee">
                ...
                 
                Supporters were Castle Hill Rotary (CHR), Kellyville Hospital (KH), the Hills Shire Council (THSC) and the Australian International Academy (AIA).  CHR provided much of the funding as this forum was free to the schools and students; KH and THSC provided showbags and items to put in them and AIA did the catering. </div>
        </div>
        <div class="one-textss module">
            <div class="title">
            ...
            <div class="sutbitlee">
                ...
                We also had exhibitors that showcased what they offered to the students to improve mental health – Castle Hill Rotary, Western Sydney Health Adolescent Team, Community Migrant Resource Centre and Youth Safe. </div>
        </div>
        <div class="one-textss module">
            <div class="title">
                Looking Ahead:
...
<section class="student">
    <div class="container">
        <div class="left">
            ...
            <div class="ul module">
                <ul>
                    ...
                    <li>
                        It is okay to get help and help can actually make you get better </li>
                    <li>
                        Its okay to not be okay </li>
                    <li>
                        Mental health matters </li>
                    <li>
                        Failure is actually feedback </li>
                    <li>
                        A good environment really matters for your mental health. </li>
                    <li>
                        This experience has helped me overcome some of my personal stigma / beliefs on mental health </li>
                    <li>
                        If I lose my smile it is okay. Life goes on </li>
                    <li>
                        There are still very clear stigmas around mental illness. </li>
                    <li>
                        You don’t need to solve people’s problems but acknowledge and listen to them </li>
                </ul>
            </div>
            <div class="button module">
                <a href="">
        ...
        <div class="right module">
            <img src="<?php echo get_template_directory_uri(); ?>/images/theyouth.png"
